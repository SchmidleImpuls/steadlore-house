...
Steadlore House may eventually grow from a manual into a supervised self-maintenance layer for household infrastructure.
...
Steadlore House is not for showing off a clever homelab.

It is for protecting the people who depend on one.

The family-use case is not secondary polish. It is the moral center.

A stressed trusted person should be able to ask:

- What is this box for?
- Can I unplug this?
- Why are the lights not working?
- Is the internet down or just Home Assistant?
- Who can help me?
- Where would Michael have stored this?
- What should I avoid touching?

And the answer should be useful, calm, current enough, and safe.
