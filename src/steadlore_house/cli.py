...
def build_parser() -> argparse.ArgumentParser:
    ...
    ai_packet = subcommands.add_parser("generate-ai-packet", help="Generate a Markdown AI Assistance Packet.")
    ...
    ai_packet.add_argument("--output", required=True, type=Path, help="Path for generated Markdown output.")
    return parser
